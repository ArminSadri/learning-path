...
```
git clone https://github.com/<your-username>/learning-path.gitcd learning-path
```

Now you have the project on your computer.

##### tip:
enter below command once so git can store your credential you'll enter later.
...
## Why do you want to learn frontend?
(Write your honest answer here. No pressure.)
...
## How many hours are you willing to assign for learning per week?
